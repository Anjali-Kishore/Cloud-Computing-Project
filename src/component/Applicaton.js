...
function ApplicationData() {
  ...
  const handleChange=(value)=>{
    fetch(`https://engineering-task.elancoapps.com/api/applications/${value}`).then((res) => res.json()).then((result) => {
  ...
  return (
    ...
    <Space size={20} direction="vertical">
      <Typography.Title level={4}>Application Data</Typography.Title>
